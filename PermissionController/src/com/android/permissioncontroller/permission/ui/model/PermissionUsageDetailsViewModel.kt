...
import com.android.permissioncontroller.permission.model.AppPermissionUsage.GroupUsage.AttributionLabelledGroupUsage
...
import com.android.permissioncontroller.permission.ui.handheld.dashboard.getDurationUsedStr
import com.android.permissioncontroller.permission.ui.handheld.dashboard.is7DayToggleEnabled
import com.android.permissioncontroller.permission.ui.handheld.dashboard.shouldShowSubattributionInPermissionsDashboard
...
class PermissionUsageDetailsViewModel(
    ...
    private fun initializeTimeFilter(context: Context) {
        filterTimes.add(TimeFilterItem(Long.MAX_VALUE,
            context.getString(R.string.permission_usage_any_time)))
        filterTimes.add(TimeFilterItem(DAYS.toMillis(7),
            context.getString(R.string.permission_usage_last_7_days)))
        filterTimes.add(TimeFilterItem(DAYS.toMillis(1),
            context.getString(R.string.permission_usage_last_day)))
        filterTimes.add(TimeFilterItem(TimeUnit.HOURS.toMillis(1),
            context.getString(R.string.permission_usage_last_hour)))
        filterTimes.add(TimeFilterItem(TimeUnit.MINUTES.toMillis(15),
            context.getString(R.string.permission_usage_last_15_minutes)))
        filterTimes.add(TimeFilterItem(TimeUnit.MINUTES.toMillis(1),
